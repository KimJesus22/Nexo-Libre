    ...
    <aside className="flex h-full flex-col border-r border-border bg-surface">
      ...
      <header className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
        ...
        <button
          type="button"
          onClick={alCrearChat}
          className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-surface-elevated hover:text-accent focus:outline-none focus:ring-2 focus:ring-accent"
