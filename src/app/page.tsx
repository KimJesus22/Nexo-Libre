      ...
      <header className="fixed top-0 z-50 w-full glass">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/registrarse"
              className="rounded-lg bg-accent px-4 py-2 text-sm font-medium text-accent-foreground transition-all hover:bg-accent-hover hover:shadow-[0_0_20px_var(--accent-glow)]"
            >
              Crear cuenta
            </Link>
          </div>
      ...
      <main className="flex flex-1 flex-col">
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <h1
              id="hero-titulo"
              className="animate-fade-in-up-delay-1 text-4xl font-extrabold leading-[1.1] tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl"
            >
            ...
            {/* Subtítulo */}
            <p className="animate-fade-in-up-delay-2 mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-foreground-secondary sm:text-xl">
            ...
            <div className="animate-fade-in-up-delay-3 mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-border px-8 py-3.5 text-base font-semibold text-foreground-secondary transition-all hover:border-accent/50 hover:text-foreground hover:bg-surface-elevated"
              >
                Conocer más
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            ...
            <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3" role="list">
              {CARACTERISTICAS.map((item) => (
                <li
                  key={item.titulo}
                  className="group rounded-2xl border border-border bg-surface p-6 transition-all hover:border-accent/30 hover:bg-surface-elevated hover:shadow-[0_0_40px_var(--accent-glow)]"
                >
